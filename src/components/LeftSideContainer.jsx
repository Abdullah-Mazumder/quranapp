...
const LeftSideContainer = ({ shortSurahList }) => {
  ...
  return (
    <div
      className="mb-2 md:mb-4 lg:mb-2 md:my-0 md:!mt-2 absolute top-0 left-0 md:static h-[96vh] w-[98%] md:w-[inherit] md:h-auto bgColor1 z-[9999] rounded-lg p-3 mx-1 md:mx-0 overflow-hidden pb-1 md:pb-3 translate-x-[-130%] md:translate-x-0"
      id="sidebar"
    >
